...
whitesource whitesource:20 whitesource:20.3 whitesource:20.3.2
```
...
### whitesource
- `whitesource`, `whitesource:20`, `whitesource:20.3`, `whitesource:20.3.2` [20/java/Dockerfile](20/java/Dockerfile)

### whitesource with node
- `whitesource:node`, `whitesource:20-node`, `whitesource:20.3-node`, `whitesource:20.3.2-node` [20/node/Dockerfile](20/node/Dockerfile)

### whitesource with dotnetcore
- `whitesource:dotnetcore`, `whitesource:20-dotnetcore`, `whitesource:20-dotnetcore-3`, `whitesource:20.3-dotnetcore`, `whitesource:20.3-dotnetcore-3.0`, `whitesource:20.3.2-dotnetcore`, `whitesource:20.3.2-dotnetcore-3.0.101` [20/dotnetcore/Dockerfile](20/dotnetcore/Dockerfile)

### whitesource with docker
- `whitesource:docker`, `whitesource:20-docker`, `whitesource:20.3-docker`, `whitesource:20.3.2-docker` [20/docker/Dockerfile](20/docker/Dockerfile)
